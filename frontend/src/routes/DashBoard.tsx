...
function DashBoard() {
  ...
  return (
    <div className="bg-[#1C1C1C] text-[#3ECF8E] min-h-[100vh] px-4 lg:px-28 pb-20">
      <Navbar />
      <div className="pt-16">
        <div className="flex items-center justify-center h-96">
          <div className="p-2 px-3 shadow-md shadow-white/10 pl-1 rounded-full bg-[#292929]  ">
        ...
        <div>
            ...
            <div className="h-full w-full flex flex-col gap-2 p-3 overflow-y-auto">
              {chat.map((ch, index) => (
                ...
                >
                  ...
                  <p className="text-white " dangerouslySetInnerHTML={{__html: ch.message.replace(/\n/g, '<br>')}} ></p>
                </div>
              ))}
            </div>
          </div>
          <div className="flex w-full justify-between p-3 bg-slate-800 rounded">
            ...
            ></textarea>
            <div className="font-bold w-1/6 grid grid-rows-2 ml-1">
              <button onClick={sendMessage} className="bg-green-500/30 text-3xl p-1 rounded mb-0.5 flex gap-5 justify-center items-center text-green-300 hover:text-green-500 fill-green-300 hover:fill-green-500">
              ...
              <button onClick={clearChat} className="bg-red-500/30 text-3xl p-1 rounded mt-0.5 flex gap-5 justify-center items-center fill-red-300 hover:fill-red-500 text-red-300 hover:text-red-500">
